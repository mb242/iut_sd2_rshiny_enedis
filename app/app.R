...
# -------------------------------------------------------------------
df_raw <- read.csv2(
  "C:/Users/2018e/Downloads/test/logements_nancy_montpellier.csv",
   header = TRUE, dec = ".", fileEncoding = "UTF-8"
 )
df <- df_raw
...
addResourcePath("test", normalizePath("C:/Users/2018e/Downloads/test"))
...
.hud-main{ background:rgba(15,23,42,0.92); border-radius:18px; padding:20px 24px 28px;
  box-shadow:0 0 0 1px rgba(56,189,248,0.35), 0 18px 45px rgba(15,23,42,0.95); }
